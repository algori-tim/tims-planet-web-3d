  ...
  return (
    <div className='modal-content'>
      ...
      <p>
        ...
        just for you. As you embark on this virtual journey, you'll not only get to know me, Tim Johnson, a bit better,
        but you'll also see some of the nifty web development work I've been up to. Let's get you acquainted with how
      ...
      <ol>
        <li>
          ...
          <p>
            This little gem is on your Heads-Up Display (HUD). It looks like a pair of walking feet - you can't miss it!
          </p>
        </li>
        <li>
      ...
      <p>
        Now, you might be wondering, "What's all this for?" Well, my friend, Tim's Planet is my way of showing you who I
        am and what I do. As a web developer, I love creating experiences that are out of this world. This planet is a
        mix of my professional work and personal interests – from the coding behind the scenes to the hobbies I sprinkle
        throughout the landscape. Think of it as a portfolio, but more interactive and, hopefully, more fun!
      </p>
      <p>
        Feel free to roam, explore, and interact as much as you like. Every corner of Tim's Planet has a story, a
        project, or a little piece of me. Enjoy your journey, and don't hesitate to reach out if you want to chat about
        the planet, web development, or anything else!
      </p>
